...
import DebugExperienceJson from "@/components/DebugExperienceJson";
        ...
        <div className="mb-5 select-none">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <button
              ...
              className={`border rounded-[6px] py-3 transition-colors ${fresherOrExp === 'fresher'
            ...
            <div
              ...
              className={`flex items-center justify-between gap-2 border rounded-[6px] px-4 py-3 transition-colors ${fresherOrExp === 'experienced'
                ? 'bg-blue-600 text-white border-blue-600'
                : 'border-[#e5e5e5] text-gray-500'
                }`}
            >
        ...
        <div className="mb-5 select-none">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`border rounded-lg py-3 transition-colors ${selectedType === 'Job'
                ? 'bg-blue-600 text-white border-blue-600'
                : 'border-[#e5e5e5] text-gray-500'
                }`}
            >
            ...
            <button
              ...
              className={`border rounded-lg py-3 transition-colors ${selectedType === 'Internship'
                ? 'bg-blue-600 text-white border-blue-600'
                : 'border-[#e5e5e5] text-gray-500'
                }`}
            >
        ...
        <div className="mb-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              className={`border rounded-lg py-3 transition-colors ${employmentType === 'full'
                ? 'bg-blue-600 text-white border-blue-600'
                : 'border-[#e5e5e5] text-gray-500'
                }`}
            >
            ...
            <button
              ...
              className={`border rounded-lg py-3 transition-colors ${employmentType === 'part'
                ? 'bg-blue-600 text-white border-blue-600'
                : 'border-[#e5e5e5] text-gray-500'
                }`}
            >
          ...
          <div className="grid grid-cols-3 gap-4">
            {['On-Site', 'Hybrid', 'Remote'].map((type) => (
              <button
                ...
                className={`border rounded-lg py-3 transition-colors ${workPlace === type
                  ? 'bg-blue-600 text-white border-blue-600'
                  : 'border-[#e5e5e5] text-gray-500'
                  }`}
              >
        ...
        <div className="mb-6">
          ...
          <div className="flex justify-between mr-10">
            <label className="flex items-center gap-2 font-normal text-[18px] text-heading">
              <input type="radio" name="contact" className="accent-blueish w-4 h-4 border-blueish" />
              Name only
            </label>
            <label className="flex items-center gap-2 font-normal text-[18px] text-heading">
              <input type="radio" name="contact" className="accent-blueish w-4 h-4 border-blueish" />
